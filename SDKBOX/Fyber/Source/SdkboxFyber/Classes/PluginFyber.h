...
namespace sdkbox
{
    ...
    public:
         ...
         *
         */
        static void startPreCaching();

        /**
         *
         */
        static void pausePreCaching();

        /**
         *
         */
        static void resumePreCaching();

        /**
         *
         */
        static void enableToastMessage(bool enabled);
         ...
         * Request the server for rewarded video availability.
         */
        static void requestRewardedVideo(const std::string& placementId);
